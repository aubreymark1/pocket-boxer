...
function playHitSound(score = 50) {
  ...
  const playBurst = () => {
    ...
    scheduleNoiseBurst(context, {
      duration: isHeavyHit ? 0.09 : 0.06,
      attack: 0.004,
      volume: isHeavyHit ? 0.07 : 0.045,
      frequency: isHeavyHit ? 1450 : 1050,
      q: 1.8,
    }, baseTime);
    scheduleNoiseBurst(context, {
      duration: isHeavyHit ? 0.13 : 0.09,
      attack: 0.006,
      volume: isHeavyHit ? 0.035 : 0.02,
      filterType: 'lowpass',
      frequency: isHeavyHit ? 420 : 300,
      q: 0.8,
    }, baseTime + 0.015);
  };
